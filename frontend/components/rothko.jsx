...
class Rothko extends React.Component {
  ...
  getDimensionsTwo() {
    ...
    let choices = [
      [
        [15, 15, width, height * 0.3],
        [15, height * 0.3 + 20, width, height * 0.7]
      ],
      [
        [15, 15, width, height * 0.4],
        [15, height * 0.4 + 20, width, height * 0.6]
      ],
      [
        [15, 15, width, height * 0.5],
        [15, height * 0.5 + 20, width, height * 0.5]
      ],
      [
        [15, 15, width, height * 0.6],
        [15, height * 0.6 + 20, width, height * 0.4]
      ],
      [
        [15, 15, width, height * 0.7],
        [15, height * 0.7 + 20, width, height * 0.3]
      ]
    ];
  ...
  drawCircle(backgroundColor, color, x, y, width, height) {
    ...
    ctx.fillStyle = color;
    this.roundRect(ctx, x + 10, y + 20, width - 25, height - 25, 50, color);
  }
