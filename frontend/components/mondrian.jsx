  ...
  drawVerticalLines() {
    ...
    switch (num) {
      case 1:
        ...
        xStart = Math.floor(seed * window.innerWidth - 10);
    ...
    for (let j = 0; j < this.xCoordinates.length; j++) {
      for (let k = 0; k < this.yCoordinates.length; k++) {
        ...
        j === this.xCoordinates.length - 1
          ? (helper[2] = window.innerWidth - this.xCoordinates[j])
          : (helper[2] = this.xCoordinates[j + 1] - this.xCoordinates[j] - 10);
        k === this.yCoordinates.length - 1
          ? (helper[3] = window.innerHeight - this.yCoordinates[k])
          : (helper[3] = this.yCoordinates[k + 1] - this.yCoordinates[k] - 10);
